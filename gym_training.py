...
EXPERIMENTS_STOP_INDEX = 100
BATCH_SIZE = 16
N_STEPS_BETWEEN_TARGET_UPDATES = 10000
N_EPISODES_PER_LOG = 20
learning_rates = [1e-3, 1e-2, 1e-1] if args.lr is None else args.lr
n_hidden = 50 if args.n_hidden is None else args.n_hidden
progress_dir = 'problem_4' if args.dir is None else args.dir
...
for learning_rate in learning_rates:
    ...
    for curr_experiment in range(EXPERIMENTS_START_INDEX, EXPERIMENTS_STOP_INDEX):
        ...
        experiences = collections.deque(maxlen=1000)
